...
sub Data {
    ...
    $Self->{Translation}->{'Please select at least one permission group.'} =
        'Sila pilih sekurang-kurangnya satu permintaan kumpulan.';
    $Self->{Translation}->{'Agent groups that can access articles in this category.'} =
        'Kumpulan ejen boleh mengakses artikel dalam kategori ini.';
    $Self->{Translation}->{'Will be shown as comment in Explorer.'} =
        'Akan dipaparkan sebagai komen dalam Explorer.';
    $Self->{Translation}->{'Do you really want to delete this category?'} =
        'Adakah anda ingin memadam kategori ini?';
    ...
    $Self->{Translation}->{'This category is used in the following FAQ article(s)'} =
        'Kategori ini digunakan dalam atiket FAQ berikut';
    $Self->{Translation}->{'This category is parent of the following subcategories'} =
        'Kategori ini adalah ibubapa kepada sub-kategori berikut';
    ...
    $Self->{Translation}->{'Do you really want to delete this FAQ article?'} =
        'Adakah anda ingin memadam artikel FAQ ini?';
    ...
    $Self->{Translation}->{'All fields marked with an asterisk (*) are mandatory.'} =
        'Semua medan yang ditandai dengan tanda bintang (*) adalah wajib.';
    ...
    $Self->{Translation}->{'Do you really want to delete this language?'} =
        'Adakah anda ingin memadamkan bahasa ini?';
    ...
    $Self->{Translation}->{'This language is used in the following FAQ Article(s)'} =
        'Bahasa ini digunakan dalam Artikel FAQ yang berikut';
    ...
    $Self->{Translation}->{'Vote (e. g. Equals 10 or GreaterThan 60)'} =
        'Undi (contoh: Bersamaan 10 atau lebih besar daripada 60)';
    $Self->{Translation}->{'Rate (e. g. Equals 25% or GreaterThan 75%)'} =
        'Kadar (contoh: Bersamaan 25% atau lebih besar daripada 75%)';
    ...
    $Self->{Translation}->{'FAQ Article Create Time (before/after)'} =
        'Waktu cipta artikel FAQ (sebelum/selepas)';
    ...
    $Self->{Translation}->{'FAQ Article Change Time (before/after)'} =
        'Waktu perubahan artikel FAQ (sebelum/selepas)';
    $Self->{Translation}->{'FAQ Article Change Time (between)'} =
        'Waktu perubahan artikel FAQ (di antara)';
    ...
    $Self->{Translation}->{'Core FAQ Data'} = 'Data Teras FAQ';
    $Self->{Translation}->{'Dynamic Info'} = 'Maklumat Dinamik';
    ...
    $Self->{Translation}->{'e. g. Equals 10 or GreaterThan 60'} =
        'contoh: Sama dengan 10 atau Lebih besar daripada 60';
    ...
    $Self->{Translation}->{'e. g. Equals 25% or GreaterThan 75%'} =
        'contoh: Sama dengan 25% atau lebih besar daripada 75%';
    ...
    $Self->{Translation}->{'No votes found! Be the first one to rate this FAQ article.'} =
        'Tiada undian ditemui! Jadilah orang pertama menilai aritl FAQ ini.';
    ...
    $Self->{Translation}->{'Found no helpful resources for the subject and text.'} =
        'Tiada sumber berguna ditemui untuk subjek dan teks.';
    $Self->{Translation}->{'Type a subject or text to get a list of helpful resources.'} =
        'Taip subjek atau teks untuk mendapatkan senarai sumber berguna.';
    ...
    $Self->{Translation}->{'Only FAQ articles created between'} =
        'Hanya artikel FAQ yang dicipta di antara';
    ...
    $Self->{Translation}->{'Search for articles with keyword'} =
        'Carian untuk artikel dengan kekunci perkataan';
    ...
    $Self->{Translation}->{'Fulltext search in FAQ articles (e. g. "John*n" or "Will*")'} =
        'Carian Teks penuh dalam artikel FAQ (contoh. "John*n" or "Will*")';
    ...
    $Self->{Translation}->{'No categories found where user has read/write permissions!'} =
        'Tiada kategori yang dijumpai dimana pengguna perlu ada keizinan baca/tulis!';
    $Self->{Translation}->{'No default language found and can\'t create a new one.'} =
        'Tiada bahasa lazim yang dijumpai dan tidak boleh membuat yang baru.';
    ...
    $Self->{Translation}->{'Was not able to delete the category %s!'} =
        'Tidak mampu untuk membuang kategori %s!';
    ...
    $Self->{Translation}->{'You have no permission for this category!'} =
        'Anda tidak mempunyai keizinan untuk kategori ini!';
    $Self->{Translation}->{'Was not able to delete the FAQ article %s!'} =
        'tidak mampu untuk membuang artikel FAQ %s!';
    ...
    $Self->{Translation}->{'Can\'t show history, as no ItemID is given!'} =
        'Tidak boleh menunjukkan sejarah, sebagai tiada ItemID yang diberikan!';
    ...
    $Self->{Translation}->{'Was not able to delete the language %s!'} =
        'Tidak mampu untuk membuang bahasa %s itu!';
    ...
    $Self->{Translation}->{'FAQ Item Create Time (before/after)'} =
        'FAQ Item Cipta Masa (sebelum/selepas)';
    ...
    $Self->{Translation}->{'FAQ Item Change Time (before/after)'} =
        'FAQ Item Ubah Masa (sebelum/selepas)';
    ...
    $Self->{Translation}->{'The voting mechanism is not enabled!'} =
        'Mekanisma mengundi tidak dibolehkan!';
    ...
    $Self->{Translation}->{'Type must be either LastCreate or LastChange or Top10!'} =
        'Jenis mesti antara LastCreate atau LastChange atau Top10!';
    ...
    $Self->{Translation}->{'Content Type'} = 'Jenis Kandungan';
    ...
    $Self->{Translation}->{'Add FAQ article'} = 'tambah artikel FAQ';
    $Self->{Translation}->{'Agent FAQ Related Articles'} = 'Artikel Berkaitan FAQ Ejen';
    $Self->{Translation}->{'Agent FAQ Related Articles.'} = 'Artikel Berkaitan FAQ Ejen.';
    ...
    $Self->{Translation}->{'Cache Time To Leave for FAQ items.'} =
        'Waktu cache untuk meninggalkan bagi item FAQ';
    $Self->{Translation}->{'Category Management'} = 'Pengurusan kategori';
    $Self->{Translation}->{'Category Management.'} = 'Pengurusan Kategori.';
    $Self->{Translation}->{'Customer FAQ Print.'} = 'Cetakan FAQ Pelanggan';
    $Self->{Translation}->{'Customer FAQ Related Articles'} = 'Artikel Berkaitan FAQ Pelanggan';
    $Self->{Translation}->{'Customer FAQ Related Articles.'} = 'Artikel Berkaitan FAQ Pelanggan.';
    ...
    $Self->{Translation}->{'Customer user attribute to check its group relation.'} =
        'Atribut pengguna pelanggan untuk memeriksa hubungan kumpulannya.';
    $Self->{Translation}->{'Decimal places of the voting result.'} =
        'Titik perpuluhan daripada keputusan undian.';
    ...
    $Self->{Translation}->{'Default language for FAQ articles on single language mode.'} =
        'Bahasa sedia ada untuk artikel FAQ pada satu mod bahasa.';
    ...
    $Self->{Translation}->{'Default state of tickets for the approval of FAQ articles.'} =
        'Keadaan sedia ada tiket untuk pengesahan daripada artikel FAQ.';
    $Self->{Translation}->{'Default type of tickets for the approval of FAQ articles.'} =
        'Jenis tetapan awal tiket untuk kelulusan artikel FAQ.';
    ...
    $Self->{Translation}->{'Define which columns are shown in the linked FAQs widget (LinkObject::ViewMode = "complex"). Note: Only FAQ attributes and dynamic fields (DynamicField_NameX) are allowed for DefaultColumns.'} =
        'Tentukan lajur mana yang dipaparkan dalam widget FAQ yang dipautkan (LinkObject::ViewMode = "complex"). Nota: Hanya atribut FAQ dan medan dinamik (DynamicField_NameX) dibenarkan untuk DefaultColumns.';
    ...
    $Self->{Translation}->{'Defines the position where the related FAQ articles widget is located.'} =
        'Mentakrifkan kedudukan di mana widget artikel FAQ berkaitan berada.';
    ...
    $Self->{Translation}->{'Defines where the \'Insert FAQ\' link will be displayed.'} =
        'Mentakrifkan di mana pautan \'Insert FAQ\' akan dipaparkan.';
    $Self->{Translation}->{'Definition of FAQ item free text field.'} =
        'Definisi item FAQ percuma bidang teks.';
    ...
    $Self->{Translation}->{'Enable counting of articles from FAQ subcategories for FAQ explorer.'} =
        'Dayakan pengiraan artikel daripada subkategori FAQ untuk penjelajah FAQ.';
    $Self->{Translation}->{'Enable customer group support permissions.'} =
        'Dayakan kebenaran sokongan kumpulan pelanggan.';
    $Self->{Translation}->{'Enable customer user permission attributes.'} =
        'Dayakan atribut kebenaran pengguna pelanggan.';
    $Self->{Translation}->{'Enable multiple languages on FAQ module.'} =
        'Aktifkan pelbagai bahasa pada modul FAQ.';
    $Self->{Translation}->{'Enable the related article feature for the agent frontend.'} =
        'Dayakan ciri artikel berkaitan untuk frontend ejen.';
    $Self->{Translation}->{'Enable the related article feature for the customer frontend.'} =
        'Dayakan ciri artikel berkaitan untuk frontend pelanggan.';
    $Self->{Translation}->{'Enable voting mechanism on FAQ module.'} =
        'Aktifkan undian mekanisma pada modul FAQ.';
    ...
    $Self->{Translation}->{'Mapping between customer user attribute value and group.'} =
        'Pemetaan antara nilai atribut pengguna pelanggan dan kumpulan.';
    ...
    $Self->{Translation}->{'Module to generate HTML OpenSearch profile for short FAQ search in the customer interface.'} =
        'Modul untuk menjana profil HTML OpenSearch bagi carian FAQ ringkas dalam antara muka pelanggan.';
    ...
    $Self->{Translation}->{'Module to generate html OpenSearch profile for short FAQ search.'} =
        'Modul untuk menjana profil HTML OpenSearch bagi carian FAQ ringkas.';
    $Self->{Translation}->{'New FAQ Article.'} = 'Artikel FAQ Baharu.';
    $Self->{Translation}->{'New FAQ articles need approval before they get published.'} =
        'Artikel baru FAQ perlu kelulusan sebelum mereka mendapat diterbitkan.';
    ...
    $Self->{Translation}->{'Number of shown items in last changes.'} =
        'Bilangan item yang ditunjukkan dalam perubahan terakhir.';
    $Self->{Translation}->{'Number of shown items in last created.'} =
        'Bilangan item yang ditunjukkan dalam terakhir dicipta.';
    $Self->{Translation}->{'Number of shown items in the top 10 feature.'} =
        'Bilangan item yang ditunjukkan dalam 10 teratas ciri.';
    $Self->{Translation}->{'Output filter to add Java-script to CustomerTicketMessage screen.'} =
        'Penapis output untuk menambah JavaScript ke skrin CustomerTicketMessage.';
    $Self->{Translation}->{'Output limit for the related FAQ articles.'} =
        'Had output untuk artikel FAQ berkaitan.';
    ...
    $Self->{Translation}->{'Queue for the approval of FAQ articles.'} =
        'Beratur untuk kelulusan artikel FAQ.';
    $Self->{Translation}->{'Rates for voting. Key must be in percent.'} =
        'Kadar untuk mengundi. Kunci mestilah dalam peratus.';
    ...
    $Self->{Translation}->{'Select how many items should be shown in Journal Overview "Small" by default.'} =
        'Pilih berapa banyak item yang dipaparkan secara lalai dalam Gambaran Keseluruhan Jurnal "Small".';
    $Self->{Translation}->{'Select how many items should be shown in Overview "Small" by default.'} =
        'Pilih berapa banyak item yang dipaparkan secara lalai dalam Gambaran Keseluruhan "Small".';
    ...
    $Self->{Translation}->{'Show last change items in defined interfaces.'} =
        'Menunjukkan item perubahan terakhir dalam antara muka yang ditakrifkan.';
    $Self->{Translation}->{'Show last created items in defined interfaces.'} =
        'Tunjukkan akhir mencipta item dalam antara muka yang ditakrifkan.';
    $Self->{Translation}->{'Show the stars for the articles with a rating equal or greater like the defined value (set value \'0\' to deactivate the output).'} =
        'Tunjukkan bintang untuk artikel dengan penilaian sama atau lebih besar daripada nilai yang ditetapkan (tetapkan nilai \'0\' untuk menyahaktifkan output).';
    $Self->{Translation}->{'Show the stars for the articles with a rating equal or greater like the defined value if enabled.'} =
        'Tunjukkan bintang untuk artikel dengan penilaian sama atau lebih besar daripada nilai yang ditetapkan jika didayakan.';
    $Self->{Translation}->{'Show top 10 items in defined interfaces.'} =
        'Papar top 10 item dalam antara muka yang ditakrifkan.';
    $Self->{Translation}->{'Show voting in defined interfaces.'} =
        'Papar mengundi dalam antara muka yang ditakrifkan.';
    ...
    $Self->{Translation}->{'The default languages for the related FAQ articles.'} =
        'Bahasa lalai untuk artikel FAQ berkaitan.';
    ...
    $Self->{Translation}->{'Ticket body for approval of FAQ article.'} =
        'Badan tiket untuk melepaskan artikel FAQ.';
    $Self->{Translation}->{'Ticket subject for approval of FAQ article.'} =
        'Tertakluk kepada tiket untuk melepaskan artikel FAQ.';
    ...
    $Self->{Translation}->{'Loader module registration for the public interface.'} =
        'Pendaftaran modul pemuat untuk antara muka awam.';
    $Self->{Translation}->{'Limitation'} = 'Had';
