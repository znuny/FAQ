...
sub Data {
    ...
    $Self->{Translation}->{'Do you really want to delete this FAQ article?'} =
        '¿Seguro que desea borrar este artículo FAQ?';
    ...
    $Self->{Translation}->{'Do you really want to delete this language?'} =
        '¿Seguro que desea borrar este idioma?';
    ...
    $Self->{Translation}->{'Vote (e. g. Equals 10 or GreaterThan 60)'} =
        'Voto (e.g. Igual a 10 o MayorQue 60)';
    $Self->{Translation}->{'Rate (e. g. Equals 25% or GreaterThan 75%)'} =
        'Valoración (e.g. Igual a 25% o MayorQue 75%)';
    ...
    $Self->{Translation}->{'FAQ Article Create Time (before/after)'} =
        'Tiempo de Creación del Artículo FAQ (antes/después)';
    $Self->{Translation}->{'FAQ Article Create Time (between)'} =
        'Tiempo de Creación del Artículo FAQ (entre)';
    $Self->{Translation}->{'FAQ Article Change Time (before/after)'} =
        'Tiempo de Modificación del Artículo FAQ (antes/después)';
    $Self->{Translation}->{'FAQ Article Change Time (between)'} =
        'Tiempo de Modificación del Artículo FAQ (entre)';
    ...
    $Self->{Translation}->{'Add FAQ title to article subject'} =
        'Agregar el título del FAQ al asunto del artículo';
    ...
    $Self->{Translation}->{'Found no helpful resources for the subject and text.'} =
        'No se encontraron recursos útiles para el asunto y texto.';
    $Self->{Translation}->{'Type a subject or text to get a list of helpful resources.'} =
        'Escriba un asunto o texto para obtener una lista de recursos útiles.';
    ...
    $Self->{Translation}->{'Only FAQ articles created between'} =
        'Únicamente artículos FAQ creados entre';
    ...
    $Self->{Translation}->{'No default language found and can\'t create a new one.'} =
        'No se encontró el idioma por omisión y no se puede crear uno nuevo.';
    ...
    $Self->{Translation}->{'Was not able to delete the category %s!'} =
        'No fue posible borrar la categoría %s!';
    ...
    $Self->{Translation}->{'You have no permission for this category!'} =
        'Usted no tiene permisos para esta categoría!';
    $Self->{Translation}->{'Was not able to delete the FAQ article %s!'} =
        'No fue posible eliminar el artículo FAQ %s!';
    ...
    $Self->{Translation}->{'Can\'t show history, as no ItemID is given!'} =
        'No se puede mostrar el historial, ya que no se ha dado un ItemID!';
    ...
    $Self->{Translation}->{'Need config option FAQ::Frontend::Overview'} =
        'Se requiere la opción de configuración FAQ::Frontend::Overview';
    $Self->{Translation}->{'Config option FAQ::Frontend::Overview needs to be a HASH ref!'} =
        '¡La opción de configuración FAQ::Frontend::Overview necesita ser una referencia a un HASH!';
    $Self->{Translation}->{'No config option found for the view "%s"!'} =
        '¡No se encontró la opción de configuración para la vista "1%s"!';
    ...
    $Self->{Translation}->{'Was not able to delete the language %s!'} =
        'No se ha podido eliminar el idioma %s!';
    ...
    $Self->{Translation}->{'FAQ Item Change Time (before/after)'} =
        'Tiempo de Actualización del Artículo FAQ (antes/después)';
    $Self->{Translation}->{'FAQ Item Change Time (between)'} =
        'Tiempo de Actualización del Artículo FAQ (entre)';
    ...
    $Self->{Translation}->{'The vote rate is not defined!'} =
        'La proporción de votación no está definida!';
    ...
    $Self->{Translation}->{'FAQ Articles (recently changed)'} =
        'Artículos FAQ (modificados recientemente)';
    ...
    $Self->{Translation}->{'Type must be either LastCreate or LastChange or Top10!'} =
        'El Tipo debe ser LastCreate LastChange o Top10';
    ...
    $Self->{Translation}->{'Customer FAQ Related Articles'} =
        'Artículos FAQ Relacionados Para Los Clientes';
    $Self->{Translation}->{'Customer FAQ Related Articles.'} =
        'Artículos FAQ Relacionados Para Los Clientes.';
    ...
    $Self->{Translation}->{'Customer user attribute to check its group relation.'} =
        'Atributo de usuario cliente para verificar su relación de grupo.';
    ...
    $Self->{Translation}->{'Default type of tickets for the approval of FAQ articles.'} =
        'Tipo por defecto de los tickets para aprobación de artículos FAQ.';
    ...
    $Self->{Translation}->{'Defines the position where the related FAQ articles widget is located.'} =
        'Define la posición donde se encuentra el widget de artículos FAQ relacionados.';
    ...
    $Self->{Translation}->{'Defines where the \'Insert FAQ\' link will be displayed.'} =
        'Definir donde será mostrado el enlace \'Insertar FAQ\'';
    ...
    $Self->{Translation}->{'Enable counting of articles from FAQ subcategories for FAQ explorer.'} =
        'Habilitar el conteo de artículos de subcategorías FAQ en el explorador FAQ.';
    $Self->{Translation}->{'Enable customer group support permissions.'} =
        'Habilitar permisos de soporte de grupos de clientes.';
    $Self->{Translation}->{'Enable customer user permission attributes.'} =
        'Habilitar atributos de permiso de usuarios clientes.';
    ...
    $Self->{Translation}->{'Enable the related article feature for the agent frontend.'} =
        'Habilitar la función de artículos relacionados en el frontend del agente.';
    ...
    $Self->{Translation}->{'FAQ AJAX Responder for Richtext.'} =
        'Respondedor AJAX de FAQ para texto enriquecido.';
    ...
    $Self->{Translation}->{'FAQ Journal Overview "Small" Limit'} =
        'Límite para la vista general «pequeña» de la Bitácora de FAQ';
    ...
    $Self->{Translation}->{'Group to which customer users belong by default (if this setting is enabled).'} =
        'Grupo al que pertenecen los usuarios clientes de forma predeterminada (si esta configuración está habilitada).';
    ...
    $Self->{Translation}->{'Interfaces where the quick search should be shown.'} =
        'Interfaces donde se debe mostrar la búsqueda rápida.';
    $Self->{Translation}->{'Journal'} = 'Bitácora';
    $Self->{Translation}->{'Language Management'} = 'Gestión de Idiomas';
    $Self->{Translation}->{'Language Management.'} = 'Gestión de Idiomas.';
    $Self->{Translation}->{'Limit for the search to build the keyword FAQ article list.'} =
        'Límite de la búsqueda para construir el listado de palabras clave de artículos FAQ.';
    ...
    $Self->{Translation}->{'Mapping between customer user attribute value and group.'} =
        'Mapeo entre el valor del atributo de usuario cliente y el grupo.';
    ...
    $Self->{Translation}->{'Output limit for the related FAQ articles.'} =
        'Límite de desplome de artículos FAQ relacionados';
    ...
    $Self->{Translation}->{'Show the stars for the articles with a rating equal or greater like the defined value if enabled.'} =
        'Mostrar las estrellas para los artículos con una calificación igual o mayor que el valor definido, si está habilitado.';
    ...
    $Self->{Translation}->{'The default languages for the related FAQ articles.'} =
        'Idiomas por defecto para los artículos FAQ relacionados.';
    ...
    $Self->{Translation}->{'Toolbar Item for a shortcut.'} =
        'Elemento de la barra de herramientas para un atajo (shortcut).';
    ...
    $Self->{Translation}->{'Loader module registration for the public interface.'} =
        'Registro de módulo "Loader" en la interfaz pública.';
